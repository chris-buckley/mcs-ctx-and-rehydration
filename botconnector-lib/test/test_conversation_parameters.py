...
class TestConversationParameters(unittest.TestCase):
    """ConversationParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationParameters:
        """Test ConversationParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationParameters`
        """
        model = ConversationParameters()
        if include_optional:
            return ConversationParameters(
                is_group = True,
                bot = bot_connector.models.channel_account.ChannelAccount(
                    id = '', 
                    name = '', 
                    aad_object_id = '', 
                    role = 'user', ),
                members = [
                    bot_connector.models.channel_account.ChannelAccount(
                        id = '', 
                        name = '', 
                        aad_object_id = '', 
                        role = 'user', )
                ...
                topic_name = '',
                tenant_id = '',
                activity = bot_connector.models.activity.Activity(
                    type = 'message', 
                    id = '', 
    ...
    def testConversationParameters(self):
        """Test ConversationParameters"""
