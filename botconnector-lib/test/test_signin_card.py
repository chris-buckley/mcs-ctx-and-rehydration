...
class TestSigninCard(unittest.TestCase):
    """SigninCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SigninCard:
        """Test SigninCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SigninCard`
        """
        model = SigninCard()
        if include_optional:
            return SigninCard(
