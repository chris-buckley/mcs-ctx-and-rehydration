...
class TestAudioCard(unittest.TestCase):
    """AudioCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AudioCard:
        """Test AudioCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AudioCard`
        """
        model = AudioCard()
        if include_optional:
            return AudioCard(
