...
class TestActivityImportance(unittest.TestCase):
    """ActivityImportance unit test stubs"""
    ...
    def testActivityImportance(self):
        """Test ActivityImportance"""
        # inst = ActivityImportance()
