...
class TestOAuthCard(unittest.TestCase):
    """OAuthCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OAuthCard:
        """Test OAuthCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OAuthCard`
        """
        model = OAuthCard()
        if include_optional:
            return OAuthCard(
