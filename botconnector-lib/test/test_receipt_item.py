...
class TestReceiptItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReceiptItem:
        """Test ReceiptItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReceiptItem`
        """
        model = ReceiptItem()
        if include_optional:
            return ReceiptItem(
