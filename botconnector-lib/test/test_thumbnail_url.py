...
class TestThumbnailUrl(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ThumbnailUrl:
        """Test ThumbnailUrl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThumbnailUrl`
        """
        model = ThumbnailUrl()
        if include_optional:
            return ThumbnailUrl(
