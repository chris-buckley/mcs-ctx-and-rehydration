...
class TestThumbnailCard(unittest.TestCase):
    """ThumbnailCard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThumbnailCard:
        """Test ThumbnailCard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThumbnailCard`
        """
        model = ThumbnailCard()
        if include_optional:
