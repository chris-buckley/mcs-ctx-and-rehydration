...
class TestEndOfConversationCodes(unittest.TestCase):
    """EndOfConversationCodes unit test stubs"""
    ...
    def testEndOfConversationCodes(self):
        """Test EndOfConversationCodes"""
        # inst = EndOfConversationCodes()
