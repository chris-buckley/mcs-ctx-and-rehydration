...
class TestCardImage(unittest.TestCase):
    """CardImage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CardImage:
        """Test CardImage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CardImage`
        """
        model = CardImage()
        if include_optional:
            return CardImage(
