...
class TestConversationReference(unittest.TestCase):
    """ConversationReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConversationReference:
        """Test ConversationReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConversationReference`
        """
        model = ConversationReference()
        if include_optional:
            return ConversationReference(
                activity_id = '',
                user = bot_connector.models.channel_account.ChannelAccount(
                    id = '', 
                    name = '', 
                    aad_object_id = '', 
                    role = 'user', ),
    ...
    def testConversationReference(self):
        """Test ConversationReference"""
