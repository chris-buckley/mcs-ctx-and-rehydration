...
class TestAttachmentLayoutTypes(unittest.TestCase):
    """AttachmentLayoutTypes unit test stubs"""
    ...
    def testAttachmentLayoutTypes(self):
        """Test AttachmentLayoutTypes"""
        # inst = AttachmentLayoutTypes()
