...
class OAuthCard(BaseModel):
    ...
    """ # noqa: E501
    text: Optional[StrictStr] = Field(default=None, description="Text for signin request")
    connection_name: Optional[StrictStr] = Field(default=None, description="The name of the registered connection", alias="connectionName")
    buttons: Optional[List[CardAction]] = Field(default=None, description="Action to use to perform signin")
    __properties: ClassVar[List[str]] = ["text", "connectionName", "buttons"]
