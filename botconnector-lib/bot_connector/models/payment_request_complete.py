...
class PaymentRequestComplete(BaseModel):
    """
    Deprecated. Bot Framework no longer supports payments.
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Payment request ID")
    payment_request: Optional[PaymentRequest] = Field(default=None, alias="paymentRequest")
    payment_response: Optional[PaymentResponse] = Field(default=None, alias="paymentResponse")
    __properties: ClassVar[List[str]] = ["id", "paymentRequest", "paymentResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentResponse": PaymentResponse.from_dict(obj["paymentResponse"]) if obj.get("paymentResponse") is not None else None
        })
        return _obj
