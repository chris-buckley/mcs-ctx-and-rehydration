...
class AttachmentView(BaseModel):
    ...
    """ # noqa: E501
    view_id: Optional[StrictStr] = Field(default=None, description="Id of the attachment", alias="viewId")
    size: Optional[StrictInt] = Field(default=None, description="Size of the attachment")
    __properties: ClassVar[List[str]] = ["viewId", "size"]
