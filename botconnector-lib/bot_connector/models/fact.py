...
class Fact(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The key for this Fact")
    value: Optional[StrictStr] = Field(default=None, description="The value for this Fact")
