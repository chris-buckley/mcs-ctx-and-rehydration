...
class AttachmentInfo(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="ContentType of the attachment")
    views: Optional[List[AttachmentView]] = Field(default=None, description="attachment views")
    __properties: ClassVar[List[str]] = ["name", "type", "views"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "type": obj.get("type"),
            "views": [AttachmentView.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None
        })
        return _obj
