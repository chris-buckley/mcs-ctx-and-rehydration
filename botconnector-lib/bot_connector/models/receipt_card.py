...
class ReceiptCard(BaseModel):
    ...
    facts: Optional[List[Fact]] = Field(default=None, description="Array of Fact objects")
    items: Optional[List[ReceiptItem]] = Field(default=None, description="Array of Receipt Items")
    tap: Optional[CardAction] = None
    total: Optional[StrictStr] = Field(default=None, description="Total amount of money paid (or to be paid)")
    tax: Optional[StrictStr] = Field(default=None, description="Total amount of tax paid (or to be paid)")
    vat: Optional[StrictStr] = Field(default=None, description="Total amount of VAT paid (or to be paid)")
    buttons: Optional[List[CardAction]] = Field(default=None, description="Set of actions applicable to the current card")
    __properties: ClassVar[List[str]] = ["title", "facts", "items", "tap", "total", "tax", "vat", "buttons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ReceiptItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
