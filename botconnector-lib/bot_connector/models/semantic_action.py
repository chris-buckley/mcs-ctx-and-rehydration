...
class SemanticAction(BaseModel):
    ...
    """ # noqa: E501
    state: Optional[SemanticActionStates] = None
    id: Optional[StrictStr] = Field(default=None, description="ID of this action")
    entities: Optional[Dict[str, Entity]] = Field(default=None, description="Entities associated with this action")
    __properties: ClassVar[List[str]] = ["state", "id", "entities"]
