...
class ConversationMembers(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Conversation ID")
    members: Optional[List[ChannelAccount]] = Field(default=None, description="List of members in this conversation")
    __properties: ClassVar[List[str]] = ["id", "members"]
