...
class MediaEventValue(BaseModel):
    ...
    """ # noqa: E501
    card_value: Optional[Dict[str, Any]] = Field(default=None, description="Callback parameter specified in the Value field of the MediaCard that originated this event", alias="cardValue")
    __properties: ClassVar[List[str]] = ["cardValue"]
