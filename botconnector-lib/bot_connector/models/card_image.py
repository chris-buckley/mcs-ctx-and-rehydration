...
class CardImage(BaseModel):
    ...
    An image on a card
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL thumbnail image for major content property")
    alt: Optional[StrictStr] = Field(default=None, description="Image description intended for screen readers")
    tap: Optional[CardAction] = None
    __properties: ClassVar[List[str]] = ["url", "alt", "tap"]
