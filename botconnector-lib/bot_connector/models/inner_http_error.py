...
class InnerHttpError(BaseModel):
    ...
    """ # noqa: E501
    status_code: Optional[StrictInt] = Field(default=None, description="HttpStatusCode from failed request", alias="statusCode")
    body: Optional[Dict[str, Any]] = Field(default=None, description="Body from failed request")
