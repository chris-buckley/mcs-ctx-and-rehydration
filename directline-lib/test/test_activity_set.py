...
class TestActivitySet(unittest.TestCase):
    """ActivitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActivitySet:
        """Test ActivitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActivitySet`
        """
        model = ActivitySet()
        if include_optional:
            return ActivitySet(
                activities = [
                    direct_line.models.activity.Activity(
                        type = '', 
                        id = '', 
                        ...
                        service_url = '', 
                        channel_id = '', 
                        from = direct_line.models.channel_account.ChannelAccount(
                            id = '', 
                            name = '', 
                            aad_object_id = '', 
                            role = '', ), 
                        conversation = direct_line.models.conversation_account.ConversationAccount(
                            is_group = True, 
                            conversation_type = '', 
                            tenant_id = '', 
                            id = '', 
                            ...
                            aad_object_id = '', 
                            role = '', ), 
                        recipient = direct_line.models.channel_account.ChannelAccount(
                            id = '', 
                            name = '', 
                            aad_object_id = '', 
                            role = '', ), 
                        ...
                        reactions_added = [
                            direct_line.models.message_reaction.MessageReaction(
                                type = '', )
                            ], 
                        reactions_removed = [
                            direct_line.models.message_reaction.MessageReaction(
                        ...
                        input_hint = '', 
                        summary = '', 
                        suggested_actions = direct_line.models.suggested_actions.SuggestedActions(
                            to = [
                                ''
                                ], 
                            actions = [
                                direct_line.models.card_action.CardAction(
                                    type = '', 
                                    title = '', 
                                    image = '', 
                                    text = '', 
                                    display_text = '', 
                                    value = direct_line.models.value.value(), 
                                    channel_data = direct_line.models.channel_data.channelData(), )
                                ], ), 
                        attachments = [
                            direct_line.models.attachment.Attachment(
                                content_type = '', 
                                content_url = '', 
                                content = direct_line.models.content.content(), 
                                name = '', 
                                thumbnail_url = '', )
                            ], 
                        entities = [
                            direct_line.models.entity.Entity(
                                type = '', )
                            ], 
                        channel_data = direct_line.models.channel_data.channelData(), 
                        action = '', 
                        ...
                        value = direct_line.models.value.value(), 
                        name = '', 
                        relates_to = direct_line.models.conversation_reference.ConversationReference(
                            activity_id = '', 
                            user = , 
                            bot = , 
                            channel_id = '', 
                        ...
                        text_highlights = [
                            direct_line.models.text_highlight.TextHighlight(
                                text = '', 
                                occurrence = 56, )
                            ], 
                        semantic_action = direct_line.models.semantic_action.SemanticAction(
                            state = '', 
                            id = '', ), )
                    ],
                watermark = ''
