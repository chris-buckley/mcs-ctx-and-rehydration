    ...
    def make_instance(self, include_optional) -> Activity:
        ...
        if include_optional:
            return Activity(
                ...
                service_url = '',
                channel_id = '',
                var_from = direct_line.models.channel_account.ChannelAccount(
                    id = '', 
                    name = '', 
                    aad_object_id = '', 
                    role = '', ),
                ...
                attachment_layout = '',
                members_added = [
                    direct_line.models.channel_account.ChannelAccount(
                        id = '', 
                        name = '', 
                        aad_object_id = '', 
                        role = '', )
                ...
                relates_to = direct_line.models.conversation_reference.ConversationReference(
                    activity_id = '', 
                    user = direct_line.models.channel_account.ChannelAccount(
                        id = '', 
                        name = '', 
                        aad_object_id = '', 
                        role = '', ), 
                    bot = direct_line.models.channel_account.ChannelAccount(
                        id = '', 
                        name = '', 
                        aad_object_id = '', 
                        role = '', ), 
                ...
                semantic_action = direct_line.models.semantic_action.SemanticAction(
                    ...
                    id = '', 
                    entities = {
                        'key' : direct_line.models.entity.Entity(
                            type = '', )
                        }, )
            )
        else:
