...
class TokensApi:
    ...
    @validate_call
    def tokens_generate_token_for_new_conversation(
        self,
        ...
        _param = self._tokens_generate_token_for_new_conversation_serialize(
    ...
    @validate_call
    def tokens_generate_token_for_new_conversation_with_http_info(
        self,
        token_parameters: Optional[TokenParameters] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def tokens_generate_token_for_new_conversation_without_preload_content(
        self,
        token_parameters: Optional[TokenParameters] = None,
        _request_timeout: Union[
            None,
    ...
    def _tokens_generate_token_for_new_conversation_serialize(
        self,
        token_parameters,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/directline/tokens/generate',
    ...
    def tokens_refresh_token(
        ...
        _param = self._tokens_refresh_token_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def tokens_refresh_token_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def tokens_refresh_token_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _tokens_refresh_token_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/directline/tokens/refresh',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
