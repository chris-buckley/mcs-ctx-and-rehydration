...
from direct_line.api_client import ApiClient, RequestSerialized
from direct_line.api_response import ApiResponse
from direct_line.rest import RESTResponseType
...
class ConversationsApi:
    ...
    @validate_call
    def conversations_get_activities(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        watermark: Annotated[Optional[StrictStr], Field(description="(Optional) only returns activities newer than this watermark")] = None,
        ...
        _param = self._conversations_get_activities_serialize(
    ...
    @validate_call
    def conversations_get_activities_with_http_info(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        watermark: Annotated[Optional[StrictStr], Field(description="(Optional) only returns activities newer than this watermark")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def conversations_get_activities_without_preload_content(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        watermark: Annotated[Optional[StrictStr], Field(description="(Optional) only returns activities newer than this watermark")] = None,
        _request_timeout: Union[
    ...
    def _conversations_get_activities_serialize(
        self,
        conversation_id,
        watermark,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/directline/conversations/{conversationId}/activities',
    ...
    @validate_call
    def conversations_post_activity(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        ...
        _param = self._conversations_post_activity_serialize(
            conversation_id=conversation_id,
            activity=activity,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def conversations_post_activity_with_http_info(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        activity: Annotated[Activity, Field(description="Activity to send")],
        _request_timeout: Union[
    ...
    @validate_call
    def conversations_post_activity_without_preload_content(
        self,
        conversation_id: Annotated[StrictStr, Field(description="Conversation ID")],
        activity: Annotated[Activity, Field(description="Activity to send")],
        _request_timeout: Union[
    ...
    def _conversations_post_activity_serialize(
        self,
        conversation_id,
        activity,
        _request_auth,
    ...
    @validate_call
    def conversations_reconnect_to_conversation(
        self,
        conversation_id: StrictStr,
        watermark: Optional[StrictStr] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._conversations_reconnect_to_conversation_serialize(
            conversation_id=conversation_id,
            watermark=watermark,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def conversations_reconnect_to_conversation_with_http_info(
        self,
        conversation_id: StrictStr,
        watermark: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def conversations_reconnect_to_conversation_without_preload_content(
        self,
        conversation_id: StrictStr,
        watermark: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _conversations_reconnect_to_conversation_serialize(
        self,
        conversation_id,
        watermark,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/directline/conversations/{conversationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def conversations_start_conversation(
        self,
        token_parameters: Optional[TokenParameters] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param token_parameters:
        :type token_parameters: TokenParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._conversations_start_conversation_serialize(
    ...
    @validate_call
    def conversations_start_conversation_with_http_info(
        self,
        token_parameters: Optional[TokenParameters] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def conversations_start_conversation_without_preload_content(
        self,
        token_parameters: Optional[TokenParameters] = None,
        _request_timeout: Union[
            None,
    ...
    def _conversations_start_conversation_serialize(
        self,
        token_parameters,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if token_parameters is not None:
            _body_params = token_parameters
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/directline/conversations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def conversations_upload(
        ...
        _param = self._conversations_upload_serialize(
            conversation_id=conversation_id,
            file=file,
            user_id=user_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def conversations_upload_with_http_info(
        self,
        conversation_id: StrictStr,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        user_id: Optional[StrictStr] = None,
    ...
    @validate_call
    def conversations_upload_without_preload_content(
        self,
        conversation_id: StrictStr,
        file: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        user_id: Optional[StrictStr] = None,
    ...
    def _conversations_upload_serialize(
        self,
        conversation_id,
        file,
        user_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/directline/conversations/{conversationId}/upload',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
