...
class SessionApi:
    ...
    def session_get_session_id(
        ...
        _param = self._session_get_session_id_serialize(
    ...
    @validate_call
    def session_get_session_id_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def session_get_session_id_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _session_get_session_id_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/directline/session/getsessionid',
