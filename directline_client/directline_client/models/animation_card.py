...
if TYPE_CHECKING:
    from ..models.animation_card_value import AnimationCardValue
...
T = TypeVar("T", bound="AnimationCard")
...
class AnimationCard:
    ...
    Attributes:
        ...
        value (Union[Unset, AnimationCardValue]): Supplementary parameter for this card
    """
    ...
    value: Union[Unset, "AnimationCardValue"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, AnimationCardValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = AnimationCardValue.from_dict(_value)
        ...
        animation_card.additional_properties = d
        return animation_card
