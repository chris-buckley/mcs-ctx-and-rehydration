...
class MediaCard:
    ...
    Attributes:
        ...
        value (Union[Unset, MediaCardValue]): Supplementary parameter for this card
    """
    ...
    value: Union[Unset, "MediaCardValue"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, MediaCardValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = MediaCardValue.from_dict(_value)
        ...
        media_card.additional_properties = d
        return media_card
