...
if TYPE_CHECKING:
    ...
    from ..models.video_card_value import VideoCardValue


T = TypeVar("T", bound="VideoCard")
...
class VideoCard:
    ...
    Attributes:
        ...
        value (Union[Unset, VideoCardValue]): Supplementary parameter for this card
    """
    ...
    value: Union[Unset, "VideoCardValue"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        value: Union[Unset, VideoCardValue]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = VideoCardValue.from_dict(_value)
        ...
        video_card.additional_properties = d
        return video_card
